...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post(`${process.env.BACKEND_URL}/api/users/register`, formData);  // Utilisation de la variable d'environnement
                ...
                <Col md={6} className="mx-auto p-4" style={{ border: '1px solid #ccc', borderRadius: '8px' }}>
                    ...
                    {showConfirmation && (
                        <Alert variant="success">
                            Félicitations, vos coordonnées ont bien été enregistrées !
                        </Alert>
                    )}
