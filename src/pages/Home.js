...
//   // Vérification pour afficher la variable d'environnement dans la console
//   useEffect(() => {
//     console.log('BACKEND_URL:', process.env.REACT_APP_BACKEND_URL); // Affiche l'URL du backend dans la console
