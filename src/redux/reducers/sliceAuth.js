...
const BACKEND_URL = process.env.REACT_APP_BACKEND_URL || 'http://localhost:8002';  // Si la variable n'est pas définie, utilise localhost:8002 par défaut
...
export const getCurrentUser = createAsyncThunk('auth/getCurrent', async () => {
    const response = await axios.get(`${BACKEND_URL}/api/users/getCurrent`, {
